...
XiaomiCyberGearDriver::~XiaomiCyberGearDriver(){}
/*
int XiaomiCyberGearDriver::init_twai(uint8_t rx_pin, uint8_t tx_pin, bool serial_debug){
...
void XiaomiCyberGearDriver::process_message(CAN_rx_msg& message){
...
void XiaomiCyberGearDriver::_send_can_package(uint8_t can_id, uint8_t cmd_id, uint16_t option, uint8_t len, uint8_t* data){
    ...
    CAN_tx_msg message;
    message.header.ExtId = id;
    message.header.StdId = id;
    message.header.DLC = len;
